...
const formSchema = z.object({
  ...
  client_phone_number: z.string().transform((v) => Number(v)||0).parse("NaN"),
  client_email: z
    .string()
    .email({
  ...
  reference_number: z.string().transform((v) => Number(v)||0).parse("NaN"),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number"
                    placeholder="Enter client's phone number" {...field} />
                  </FormControl>
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="number" placeholder="Enter reference number" {...field} />
                  </FormControl>
                </FormItem>
              )}
            />
